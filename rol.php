                    ...
                    <form METHOD="POST" action="rol.php" id="form" name="form">
                                    ...
                                    <div class="col">
                                        <select class="form-control" id="codRol" name="codRol" form="form">
                                            <?php  if ($rol->num_rows > 0) { while($row1 = $rol->fetch_assoc()) { ?>
                                                <option <?php if($codRol!="" && $codRol == $row1["COD_ROL"] ){echo "selected";}  ?>
                                                    value=<?php echo $row1["COD_ROL"]?>> <?php echo $row1["NOMBRE"]?>
                                                </option>
                                            <?php } } ?>
                                        </select>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <div class="col">
                                        <select class="form-control" id="codModulo" name="codModulo" form="form">
                                            <?php  if ($modulos->num_rows > 0) { while($row1 = $modulos->fetch_assoc()) { ?>
                                ...
                                <?php if($accion== "Agregar"){ ?>
                                    <div class="card">
                                        ...
                                        <table class="table table-head-fixed text-nowrap">
                                            ...
                                            <tbody>
                                                <?php if($result!=""){ if ($result->num_rows > 0) { while($row = $result->fetch_assoc()) { ?>
                                                <tr>
                                                    <td><?php echo $row["NOMBRE"]?></td>
                                                    <td><input type="radio" name="eliCodigo"
                                                            value="<?php echo $row["COD_MODULO"]?>">
                                                    </td>
                                                </tr>
                                                <?php  }?>
